...
#        assert_that(number_of_elements==2, "Кол-во элементов в списке processed_result не соответсвует 2, а равно - %d"%number_of_elements)
        ...
        #     count=count+1
        #     assert_that(Unit == '0/ME5200' or Unit == '0/ME2001',"Параметр Unit в строке %s в выводе команды не соответсвуют ожидамым значениям ME2001 или ME5200, а равен - %s"%(count+1,Unit))
        ...
        # conn.send('quit\r')
        # conn.close()
        assert_that(Unit1 == '0/ME5200' or Unit1 == '0/ME2001',"Параметр Unit1 в выводе команды не соответсвуют ожидамым значениям ME2001 или ME5200, а равен - %s"%Unit1)
        assert_that(Image1 == '0',"Параметр Image1 в выводе команды не соответсвуют ожидаемому значению 0 , а равен - %s"%Image1)
        assert_that((Boot1 == '' and Run_status1=='No') or (Boot1 == '*' and Run_status1=='Yes'),"Параметры Boot1 и Run_status1 в выводе команды не соответсвуют ожидамым значениям '' и No или '*'' и Yes соответсвенно, а равны Boot1 - %s и Run_status1 - %s"%(Boot1,Run_status1))
        assert_that(Version1 != '' ,"Параметр Version1 в выводе команды не соответсвуют шаблону, а равен - %s"%Version1)
        assert_that(Date1 != '' ,"Параметр Date1 в выводе команды не соответсвуют шаблону, а равен - %s"%Date1) 

        assert_that(Unit2 == '0/ME5200' or Unit2 == '0/ME2001',"Параметр Unit2 в выводе команды не соответсвуют ожидамым значениям ME2001 или ME5200, а равен - %s"%Unit2)
        assert_that(Image2 == '1',"Параметр Image2 в выводе команды не соответсвуют ожидаемому значению 1, а равен - %s"%Image2)
        assert_that((Boot2 == '' and Run_status2=='No') or (Boot2 == '*' and Run_status2=='Yes'),"Параметры Boot2 и Run_status2 в выводе команды не соответсвуют ожидамым значениям '' и No или '*' и Yes соответсвенно, а равны Boot2 - %s и Run_status2 - %s"%(Boot2,Run_status2))
        assert_that(Version2 != '' ,"Параметр Version2 в выводе команды не соответсвуют шаблону, а равен - %s"%Version2)
...
#        assert_that(number_of_elements==4, "Кол-во элементов в списке processed_result не соответсвует 4, а равно - %d"%number_of_elements)
        ...
        #     Date = processed_result[count]['Date']
        #     count=count+1
        #     assert_that(Unit == '0/FMC0' or Unit == '0/FMC1' ,"Параметр Unit в строке %s в выводе команды не соответсвуют ожидамым значениям 0/FMC0 или 0/FMC1, а равен - %s"%(count+1,Unit))
        #     assert_that(Image == '0',"Параметр Image в строке %s в выводе команды не соответсвуют ожидаемому значению 0 , а равен - %s"%(count+1,Image))
        #     assert_that((Boot == ' ' and Run_status=='No') or (Boot == '*' and Run_status=='Yes'),"Параметры Boot и Run_status в строке %s в выводе команды не соответсвуют ожидамым значениям '' и No или '*'' и Yes соответсвенно, а равны Boot - %s и Run_status - %s"%(count+1,Boot,Run_status))
        #     assert_that(Version != '' ,"Параметр Version в строке %s в выводе команды не соответсвуют шаблону, а равен - %s"%(count+1,Version))
        #     assert_that(Date != '' ,"Параметр Date в строке %s в выводе команды не соответсвуют шаблону, а равен - %s"%(count+1,Date)) 
       ...
       # Date4 = processed_result[3]['Date']
        ...
        assert_that(Unit1 == '0/FMC0',"Параметр Unit1 в выводе команды не соответсвуют ожидамым значениям 0/FMC0, а равен - %s"%Unit1)
        assert_that(Image1 == '0',"Параметр Image1 в выводе команды не соответсвуют ожидаемому значению 0, а равен - %s"%Image1)
        assert_that((Boot1 == '' and Run_status1=='No') or (Boot1 == '*' and Run_status1=='Yes'),"Параметры Boot1 и Run_status1 в выводе команды не соответсвуют ожидамым значениям '' и No или '*' и Yes соответсвенно, а равны Boot1 - %s и Run_status1 - %s"%(Boot1,Run_status1))
        assert_that(Version1 != '' ,"Параметр Version1 в выводе команды не соответсвуют шаблону, а равен - %s"%Version1)
        assert_that(Date1 != '' ,"Параметр Date1 в выводе команды не соответсвуют шаблону, а равен - %s"%Date1) 

        assert_that(Unit2 == '0/FMC0',"Параметр Unit2 в выводе команды не соответсвуют ожидамым значениям 0/FMC0, а равен - %s"%Unit2)
        assert_that(Image2 == '1',"Параметр Image2 в выводе команды не соответсвуют ожидаемому значению 1, а равен - %s"%Image2)
        assert_that((Boot2 == '' and Run_status2=='No') or (Boot2 == '*' and Run_status2=='Yes'),"Параметры Boot2 и Run_status2 в выводе команды не соответсвуют ожидамым значениям '' и No или '*' и Yes соответсвенно, а равны Boot2 - %s и Run_status2 - %s"%(Boot2,Run_status2))
        assert_that(Version2 != '' ,"Параметр Version2 в выводе команды не соответсвуют шаблону, а равен - %s"%Version2)
        assert_that(Date2 != '' ,"Параметр Date2 в выводе команды не соответсвуют шаблону, а равен - %s"%Date2) 
       ...
       # assert_that(Unit3 == '0/FMC1',"Параметр Unit3 в выводе команды не соответсвуют ожидамым значениям 0/FMC1, а равен - %s"%Unit3)
       # assert_that(Image3 == '0',"Параметр Image1 в выводе команды не соответсвуют ожидаемому значению 0, а равен - %s"%Image3)
       # assert_that((Boot3 == ' ' and Run_status3=='No') or (Boot3 == '*' and Run_status3=='Yes'),"Параметры Boot3 и Run_status3 в выводе команды не соответсвуют ожидамым значениям '' и No или '*' и Yes соответсвенно, а равны Boot3 - %s и Run_status3 - %s"%(Boot3,Run_status3))
       # assert_that(Version3 != '' ,"Параметр Version3 в выводе команды не соответсвуют шаблону, а равен - %s"%Version3)
       # assert_that(Date3 != '' ,"Параметр Date3 в выводе команды не соответсвуют шаблону, а равен - %s"%Date3) 

       # assert_that(Unit4 == '0/FMC1',"Параметр Unit4 в выводе команды не соответсвуют ожидамым значениям 0/FMC1, а равен - %s"%Unit4)
       # assert_that(Image4 == '1',"Параметр Image4 в выводе команды не соответсвуют ожидаемому значению 1, а равен - %s"%Image4)
       # assert_that((Boot4 == ' ' and Run_status4=='No') or (Boot4 == '*' and Run_status4=='Yes'),"Параметры Boot4 и Run_status4 в выводе команды не соответсвуют ожидамым значениям '' и No или '*' и Yes соответсвенно, а равны Boot4 - %s и Run_status4 - %s"%(Boot4,Run_status4))
       # assert_that(Version4 != '' ,"Параметр Version4 в выводе команды не соответсвуют шаблону, а равен - %s"%Version4)
      #  assert_that(Date4 != '' ,"Параметр Date4 в выводе команды не соответсвуют шаблону, а равен - %s"%Date4) 
