...
@allure.title('Проверка доступности маршрутизатора по протоколу Telnet')
@pytest.mark.part1
@pytest.mark.login
...
def test_telnet_login_part1(ip, login, password):
    """Проверяем доступность по telnet (т.е. локальную аутентификацию)"""
